...
const CustomInsightPage = () => {
        ...
        const fetchUserIdAndDocumentTypes = async () => {
            ...
            try {
                ...
                const response = await safeApiCall(
                    () => axios.get('http://localhost:8080/documents/types'),
                    'Failed to fetch document types.',
                    () => message.success('Document types fetched successfully!')
                );
    ...
    const safeApiCall = async (apiCall, errorMessage, successCallback) => {
        try {
